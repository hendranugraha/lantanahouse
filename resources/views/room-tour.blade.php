...
@section('content')
    <section class="relative h-screen w-full overflow-hidden bg-[#3D2B1F]">
        <video class="absolute inset-0 w-full h-full object-cover scale-[1.2] md:scale-[1.15]" autoplay muted loop playsinline>
        ...
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div class="space-y-12">
                <div class="grid md:grid-cols-2 gap-8 items-center">
                    <img src="/SLZ00423.jpg" alt="{{ __('room_tour.living_alt') }}" class="w-full rounded-lg" loading="lazy" decoding="async" sizes="(max-width: 768px) 100vw, 50vw">
                    <div>
                ...
                <div class="grid md:grid-cols-2 gap-8 items-center">
                    <img src="/SLZ00429.jpg" alt="{{ __('room_tour.master_alt') }}" class="w-full rounded-lg" loading="lazy" decoding="async" sizes="(max-width: 768px) 100vw, 50vw">
                    <div>
                ...
                <div class="grid md:grid-cols-2 gap-8 items-center">
                    <img src="/SLZ00438.jpg" alt="{{ __('room_tour.bath_alt') }}" class="w-full rounded-lg" loading="lazy" decoding="async" sizes="(max-width: 768px) 100vw, 50vw">
                    <div>
