...
@section('content')
    <section class="pt-0 pb-12 md:pt-8 md:pb-16 bg-white">
        <section class="relative h-screen w-full overflow-hidden rounded-none mb-6 md:mb-12">
        ...
        <div class="max-w-7xl mx-auto px-6">
            <div class="grid md:grid-cols-2 gap-20 items-center">
                ...
                <div>
                    <img src="/SLZ00383.jpg" alt="{{ __('about.img_story_alt') }}" class="w-full rounded-lg" loading="lazy" decoding="async" sizes="(max-width: 768px) 100vw, 50vw">
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-20 md:py-28 bg-white">
        <div class="max-w-7xl mx-auto px-6">
            <div class="grid md:grid-cols-2 gap-20 items-center">
                <div>
                    <img src="/SLZ00365.jpg" alt="{{ __('about.img_garden_alt') }}" class="w-full rounded-lg" loading="lazy" decoding="async" sizes="(max-width: 768px) 100vw, 50vw">
                </div>
                <div>
